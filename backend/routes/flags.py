...
async def add_flag_event(
    ...
    if event_id in flagged_ids:
        return {"message": "Already flagged", "flagged_event_ids": flagged_ids}
    ...
    return {"message": "Added to flags", "flagged_event_ids": flagged_ids}
...
async def remove_flag_event(
    ...
    if event_id not in flagged_ids:
        return {"message": "Not flagged", "flagged_event_ids": flagged_ids}
